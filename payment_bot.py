...
payment_keyboard = [
    types.InlineKeyboardButton("Оплата", callback_data='payment_but')
]
payment_button = types.InlineKeyboardMarkup().add(*payment_keyboard)
...
async def start(message:types.Message):
    ...
    await message.answer("Если вы сделали оплату, нажмите на кнопку", reply_markup=payment_button)
...
@dp.callback_query_handler(lambda call: call.data == "payment_but")
async def payment_student(message:types.CallbackQuery):
